...
class Book{
    ...
    function create(){
        ...
        $query = "INSERT INTO
                    " . $this->table_name . "
                SET
                    acc_no=:acc_no, shelf_no=:shelf_no, call_no=:call_no, author=:author, title=:title, description=:description, isbn=:isbn,  publisher=:publisher, released_year=:released_year, status=:status, remark=:remark";
    ...
    function readAll($from_record_num, $records_per_page){
        ...
        $query = "SELECT
                acc_no, shelf_no, call_no, author, title, description, isbn,  publisher, released_year, status, remark
            FROM
                " . $this->table_name . "
            ORDER BY
                id DESC
    ...
    public function search($search_term, $from_record_num, $records_per_page){
        ...
        $query = "SELECT
            ...
            FROM
                " . $this->table_name . "
            WHERE
                author LIKE ? OR title LIKE ? OR description LIKE ? OR released_year LIKE ?
            ORDER BY
                acc_no ASC
            LIMIT
                ?, ?";
